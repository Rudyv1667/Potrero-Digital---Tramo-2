...
<!-- Formulario -->            
            ...
            <form name="submit-to-google-sheet" class="submit-to-google-sheet" action="editar_producto1.php" method="post">
                <fieldset>
                <legend>
                    Editar un producto
                </legend>
                <label for="Proveedor" class="Proveedor">Proveedor</label>
                <input type="text" name="Marca" id="Proveedor" value="'.$unaFila['Marca'].'"></input>

                <label for="Producto" class="Producto">Producto</label>
                <input type="text" name="Producto" id="Producto" value="'.$unaFila['Producto'].'"></input>
                ...
                <input type="hidden" id="id_nuevo" name="id_nuevo" value='.$unaFila['id'].'>
