                                        ...
                                        <table class="table m-0">
                                            ...
                                            <tbody>
                                                ...
                                                if(isset($_GET['add_msg'])){
                                                    echo "<h6 color=green>".$_GET['add_msg']."</h6><br>";
                                                }

                                                echo '<a href="agregar_producto.php?id='.$unaFila["id"].'"><button class="btn btn-primary btn-sm rounded-0 m-0" type="button" title="Edit">AGREGAR UN PRODUCTO <i class="fa-solid fa-arrow-up-from-bracket"></i></button></a>';
